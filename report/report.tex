...
在参考正平衡点处校准为相同 20\% 抑制后，五种恐惧机制均保持共存，但长期均值方向明显不同（机制比较柱状图见附录\,\ref{fig:mechanisms}）。三种繁殖抑制路径使捕食者均值下降约 16.7\%--18.0\%，猎物均值基本不变；觅食抑制与处理时间延长同时提高猎物和捕食者均值。这说明”恐惧增加或减少种群”没有脱离机制路径的统一答案。
